...
/*------------------------------------------------------------*/
void zz_pX_Multipoint_Geometric::to_dense(Mat<zz_p>& M) const {
   zz_pX f;
   set(f);
   Vec<zz_p> v;
   v.SetLength(n);
...
/* evaluation                                                 */
/*------------------------------------------------------------*/
void zz_pX_Multipoint_Geometric::mul_right(Vec<zz_p>& output, const Vec<zz_p>& input) const{
  zz_pX f;
  f.rep.SetLength(n);
  for (long i = 0; i < n; i++)
    f.rep[i] = input[i];
...
/*------------------------------------------------------------*/
void zz_pX_Multipoint_Geometric::mul_left(Vec<zz_p>& output, const Vec<zz_p>& input) const{
...
/* interpolation                                              */
/*------------------------------------------------------------*/
void zz_pX_Multipoint_Geometric::inverse_mul_right(Vec<zz_p>& output, const Vec<zz_p>& input) const{
  zz_pX f;
  interpolate(f, input);
  output.SetLength(n);
...
/*------------------------------------------------------------*/
/*------------------------------------------------------------*/
void zz_pX_Multipoint_Geometric::inverse_mul_left(Vec<zz_p>& output, const Vec<zz_p>& input) const{
  ...
  output.SetLength(n);
  for (long i = 0; i < n; i++)
    output[i] = coeff(R, i) * inverse_derivative[i];
