...
void hermite_pade_algebraic::switch_context(long n){
...
/*----------------------------------------------------------------*/
Vec<ZZ_p> hermite_pade_algebraic::find_original_sol(const Vec<ZZ_p> &b){
  Vec<ZZ_p> x;
...
/*----------------------------------------------------------------*/
Vec<ZZ_p> hermite_pade_algebraic::mulA_right(const Vec<ZZ_p>& b){
  Vec<ZZ_p> b_loc = b;
...
/*----------------------------------------------------------------*/
void hermite_pade_algebraic::update_solution(Vec<ZZ>& x, const Vec<ZZ_p> &b, long n){
...
/*----------------------------------------------------------------*/
void hermite_pade_algebraic::DAC(Vec<ZZ> &x, const Vec<ZZ>& b_in, long n){
...
bool hermite_pade_algebraic::can_reconstruct(const Vec<ZZ_p> &v, long n){
  if (n == 0) 
    return false;
...
void hermite_pade_algebraic::reconstruct(Vec<Vec<ZZ>> &sol, const Vec<ZZ_p> &v, long n){
  for (long i = 0; i < v.length(); i++){
    ZZ a, b;
...
void hermite_pade_algebraic::find_rand_sol(Vec<Vec<ZZ>> &sol){
